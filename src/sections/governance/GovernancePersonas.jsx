...
const personas = [
  {
    key: 'Single CRM', avatar: avatarBlue, img: personaCircle, tag: 'SINGLE CRM', color: '#175FA4',
  ...
  {
    key: 'Multi CRM', avatar: avatarCloud, img: personaCloud, tag: 'MULTI CRM', color: '#175FA4',
  ...
  {
    key: 'New Admin', avatar: personaGhost, img: personaGhost, tag: 'NEW ADMIN', color: '#12807F',
  ...
  {
    key: 'AI Prep', avatar: avatarFlower, img: personaFlower, tag: 'AI PREP', color: '#D5453F',
  ...
  {
    key: 'Agency', avatar: avatarTriangle, img: personaTriangle, tag: 'AGENCY', color: '#D6931F',
  ...
  return (
    <section className="section--grey section--tight">
      <div className="container">
        ...
        <p className="section-sub reveal">Pick who sounds like your Monday — see the first thing they&rsquo;d see.</p>
