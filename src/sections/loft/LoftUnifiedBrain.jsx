...
const labels = [
  { text: 'One customer timeline', top: '0%', left: '50%', color: 'var(--teal-600)' },
  { text: 'No duplicate contacts', top: '24%', left: '86%', color: 'var(--blue-600)' },
  { text: 'No syncing issues', top: '76%', left: '86%', color: 'var(--blue-600)' },
  { text: 'AI insights everywhere', top: '100%', left: '50%', color: 'var(--gold-600)' },
  { text: 'No manual updates', top: '50%', left: '2%', color: 'var(--red-500)' },
];
  ...
  return (
    <section className="section orbit-section">
      <div className="container">
        <h2 className="section-title reveal">Every customer. Every conversation.<br />One AI brain.</h2>
        <p className="section-sub reveal">Loft unifies your whole revenue stack into one intelligent platform that automatically updates and gives your visibility</p>
